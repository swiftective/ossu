...
(check-expect (lookup empty 10) false)
(check-expect (lookup (list (make-account 10 "Bob")) 10)  "Bob")
(check-expect (lookup (list (make-account 20 "Bob")) 10)  false)

;; (define (lookup accs n) "")

; took template from Accounts
