...
datatype 'a myrecord = Rec of 'a | RecN of 'a myrecord * 'a myrecord

val record3 : int myrecord = Rec 1

val record2 : string myrecord = RecN (Rec "record1", Rec "record2")

val record = RecN (RecN (Rec "record1", Rec "record2") , Rec "record3")

fun append_string r =
  case r of
       Rec str => str
     | RecN (r1, r2) => append_string r1 ^ " " ^ append_string r2


val func_record_test = append_string record = "record1 record2 record3"
